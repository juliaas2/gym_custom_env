...
Write-Host "ETAPA 1: Treinando 5x5" -ForegroundColor Green
Write-Host "======================================" -ForegroundColor Green
& $PY train_grid_world_cpp.py train 5 3 200 1000000 --run-name modelo_final --eval-episodes 50 --view-radius 2

if ($LASTEXITCODE -ne 0) {
    Write-Host "Erro na ETAPA 1! Abortando..." -ForegroundColor Red
    exit 1
}
...
Write-Host "Carregando modelo: $($modelo_5x5.Name)" -ForegroundColor Yellow
...
Write-Host "======================================" -ForegroundColor Green
Write-Host "Modelo salvo em: data/modelo_final_20x20_best.zip" -ForegroundColor Green
