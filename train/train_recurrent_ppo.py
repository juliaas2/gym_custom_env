...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Stage 2: RecurrentPPO + MultiInputLstmPolicy on CPP.")
...
def main() -> None:
    ...
    exp_id = run_id("recurrent_ppo", cfg, args.seed)
    ...
    rows, summary = evaluate_recurrent(
        model, eval_env, episodes=args.eval_episodes, seed=args.seed + 10_000
    )
    eval_env.close()
    env.close()
